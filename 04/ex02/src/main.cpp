...
/*   Updated: 2026/06/19 20:11:50 by sscheini         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 */
static void	fillPack(AAnimal *pack[ANIMAL_AMOUNT]) {
	int	i;
 ...
 */
static void	speakWithAnimals(AAnimal *pack[ANIMAL_AMOUNT], AAnimal *secondPack[ANIMAL_AMOUNT]) {
	int	i;
 ...
 */
static void	deepCopyTest(AAnimal *pack[ANIMAL_AMOUNT], AAnimal *secondPack[ANIMAL_AMOUNT]) {
	int	i;
 ...
 */
int	main(void) {
	AAnimal		*pack[ANIMAL_AMOUNT];
	AAnimal		*secondPack[ANIMAL_AMOUNT];
	int			i;

	//Uncomment to test abstract class instantiation (should fail to compile):
	//AAnimal concept;
	//AAnimal *concept = new AAnimal();
